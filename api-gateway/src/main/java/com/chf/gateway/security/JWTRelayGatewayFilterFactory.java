package com.chf.gateway.security;

import static com.chf.core.security.jwt.reactive.JWTFilter.AUTHORIZATION_HEADER;
    ...
    public GatewayFilter apply(Object config) {
        return (exchange, chain) -> {
            ...
            if (StringUtils.hasText(token) && this.tokenProvider.validateToken(token)) {
                ServerHttpRequest request = exchange.getRequest().mutate().header(JWTFilter.AUTHORIZATION_HEADER, "Bearer " + token).build();
