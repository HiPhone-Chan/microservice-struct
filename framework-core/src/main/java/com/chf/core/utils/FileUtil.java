...
public class FileUtil {
    ...
    public static String readFile2String(MultipartFile file) {
        try {
    ...
    public static void writeFile(MultipartFile src, String dst) {
        writeFile(src, new File(dst));
    }

    public static void writeFile(MultipartFile src, File dst) {
    ...
    public static void moveFile(File from, File to) {
        try {
            ...
            LOG.info("Move file exception : {} ", e.getMessage());
        }
    }
