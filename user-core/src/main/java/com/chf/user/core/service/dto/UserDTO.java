package com.chf.user.core.service.dto;
...
public class UserDTO {
    ...
    public UserDTO(User user) {
        this(user.getId(), user.getLogin(), user.getName(), user.getNickName(), user.getFirstName(), user.getLastName(),
                user.getEmail(), user.getMobile(), user.getImageUrl(), user.isActivated(), user.getLangKey(),
                user.getCreatedBy(), user.getCreatedDate(), user.getLastModifiedBy(), user.getLastModifiedDate(),
                user.getAuthorities().stream().map(Authority::getName).collect(Collectors.toSet()));
    }

    public UserDTO(Long id, String login, String name, String nickName, String firstName, String lastName, String email,
